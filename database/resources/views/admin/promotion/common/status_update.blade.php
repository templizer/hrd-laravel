    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title">Promotion Status Update</h5>
            </div>
            <div class="modal-body">
                <div class="container">
                    <form class="forms-sample" id="updatePromotionStatus" action="" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <select class="form-select" id="status" name="status">
                                    @foreach(\App\Enum\HrSetupStatusEnum::cases() as $case)
                            ...
                            <div class="col-lg-12 mb-3">
                                <textarea class="form-select" id="remark" minlength="10" name="remark" rows="3"></textarea>
                            </div>
                        </div>
